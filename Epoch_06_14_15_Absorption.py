...
#PV SECTION
#------------------------------------------------------------------------------
PV_Spect_FX_4=  Epoch_06_14_15_FLUX[find_index(Epoch_06_14_15_WAVE,closest_value(Epoch_06_14_15_WAVE,1140)):find_index(Epoch_06_14_15_WAVE,closest_value(Epoch_06_14_15_WAVE,1200))]
...
col2=fits.Column(name='flux'      ,format='D',array=PV_Spect_FX_4)
col3=fits.Column(name='error'     ,format='D',array=PV_Spect_ER_4)
cols = fits.ColDefs([col1, col2, col3])
tbhdu = fits.BinTableHDU.from_columns(cols)
tbhdu.writeto('PV_Epoch_06_14_15.fits')
#"""
#------------------------------------------------------------------------------
#SiIV SECTION
#------------------------------------------------------------------------------
...
plt.plot(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,zorder=0,c='blue',linewidth=2)
plt.plot(x_poly_SiIV,y_poly_SiIV, 'ro')
plt.plot(Epoch_06_14_15_WAVE,splinesSiIV(Epoch_06_14_15_WAVE), 'w')
plt.axis([1450,1490,.2,3])
fig = plt.gcf()
fig.set_size_inches(13.5, 10.5)
#------------------------------------------------------------------------------
...
CIV_Polyfit_Points=[make_polyfit_point(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,1601.4,1603.4),
                    ...
                    make_polyfit_point(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,1633.3,1633.6),
                    ...
                    make_polyfit_point(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,1642.4,1642.8),
                    ...
                    #make_polyfit_point(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,1650.0,1652.0),
                    make_polyfit_point(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,1654.2,1656.2),
                    make_polyfit_point(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,1661.4,1662.2),
...
plt.plot(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,zorder=0,c='blue',linewidth=2)
plt.plot(x_poly_CIV,y_poly_CIV, 'ro')
plt.plot(Epoch_06_14_15_WAVE,splinesCIV(Epoch_06_14_15_WAVE), 'w')
plt.axis([1605,1675,.02,5])
fig = plt.gcf()
fig.set_size_inches(13.5, 10.5)
#------------------------------------------------------------------------------
...
plt.plot(Epoch_06_14_15_WAVE,Epoch_06_14_15_FLUX,zorder=0,c='blue',linewidth=2)
plt.plot(x_poly_NV,y_poly_NV, 'ro')
plt.plot(Epoch_06_14_15_WAVE,splinesNV(Epoch_06_14_15_WAVE), 'w')
plt.axis([1260,1340,.02,15])
fig = plt.gcf()
fig.set_size_inches(13.5, 10.5)
#------------------------------------------------------------------------------
