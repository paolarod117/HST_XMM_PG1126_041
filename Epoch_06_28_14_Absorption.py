...
plt.plot(PV_Spect_WL_3,PV_Spect_FX_3,zorder=0,c='blue',linewidth=2)
...
plt.ylabel('Flux (ratio)')
plt.axhline(y=1,color='grey')
plt.plot(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,zorder=0,c='blue',linewidth=2)
...
plt.plot(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,zorder=0,c='blue',linewidth=2)
plt.plot(x_poly_SiIV,y_poly_SiIV, 'ro')
plt.plot(Epoch_06_28_14_WAVE,splinesSiIV(Epoch_06_28_14_WAVE), 'black')
plt.axis([1450,1490,.2,3])
fig = plt.gcf()
fig.set_size_inches(13.5, 10.5)
#------------------------------------------------------------------------------
...
plt.ylabel('Flux (ratio)')
plt.axhline(y=1,color='grey')
plt.plot(SiIV_Spect_WL_3,SiIV_Spect_FX_3,zorder=0,c='blue',linewidth=2)
...
"""
col1=fits.Column(name='wavelength',format='D',array=SiIV_Spect_WL_3)
col2=fits.Column(name='flux'      ,format='D',array=SiIV_Spect_FX_3)
col3=fits.Column(name='error'     ,format='D',array=SiIV_Spect_ER_3)
cols = fits.ColDefs([col1, col2, col3])
tbhdu = fits.BinTableHDU.from_columns(cols)
tbhdu.writeto('SiIV_Epoch_06_28_14.fits')
#"""
#------------------------------------------------------------------------------
#CIV
#------------------------------------------------------------------------------
...
plt.plot(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,zorder=0,c='blue',linewidth=2)
plt.plot(x_poly_CIV,y_poly_CIV, 'ro')
plt.plot(Epoch_06_28_14_WAVE,splinesCIV(Epoch_06_28_14_WAVE), 'black')
plt.axis([1605,1675,.02,5])
fig = plt.gcf()
fig.set_size_inches(13.5, 10.5)
#------------------------------------------------------------------------------
...
plt.ylabel('Flux (ratio)')
plt.axhline(y=1,color='grey')
plt.plot(CIV_Spect_WL_3,CIV_Spect_FX_3,zorder=0,c='blue',linewidth=2)
...
"""
col1=fits.Column(name='wavelength',format='D',array=CIV_Spect_WL_3)
col2=fits.Column(name='flux'      ,format='D',array=CIV_Spect_FX_3)
col3=fits.Column(name='error'     ,format='D',array=CIV_Spect_ER_3)
cols = fits.ColDefs([col1, col2, col3])
tbhdu = fits.BinTableHDU.from_columns(cols)
tbhdu.writeto('CIV_Epoch_06_28_14.fits')
#"""
#------------------------------------------------------------------------------
#NV
#------------------------------------------------------------------------------
...
NV_Polyfit_Points =[make_polyfit_point(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,1257,1258),
                    ...
                    #make_polyfit_point(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,1301.7,1301.85),
                    ...
                    make_polyfit_point(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,1337,1338),
                    make_polyfit_point(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,1347,1348),
                    make_polyfit_point(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,1360,1362)]       
#------------------------------------------------------------------------------
#From 2D list, this provides two 1D lists
...
PreNormalizedNV_FX=Epoch_06_28_14_FLUX[find_index(Epoch_06_28_14_WAVE,closest_value(Epoch_06_28_14_WAVE,1260)):find_index(Epoch_06_28_14_WAVE,closest_value(Epoch_06_28_14_WAVE,1340))]
#------------------------------------------------------------------------------
plt.figure(12)
...
plt.plot(Epoch_06_28_14_WAVE,Epoch_06_28_14_FLUX,zorder=0,c='blue',linewidth=2)
plt.plot(x_poly_NV,y_poly_NV, 'ro')
plt.plot(Epoch_06_28_14_WAVE,splinesNV(Epoch_06_28_14_WAVE), 'black')
plt.axis([1260,1340,.02,15])
fig = plt.gcf()
fig.set_size_inches(13.5, 10.5)
#------------------------------------------------------------------------------
#Creates list for NV region.
NV_Spect_ER_3=Epoch_06_28_14_ERROR[find_index(Epoch_06_28_14_WAVE,closest_value(Epoch_06_28_14_WAVE,1260)):find_index(Epoch_06_28_14_WAVE,closest_value(Epoch_06_28_14_WAVE,1340))]
NV_Spect_WL_3= Epoch_06_28_14_WAVE[find_index(Epoch_06_28_14_WAVE,closest_value(Epoch_06_28_14_WAVE,1260)):find_index(Epoch_06_28_14_WAVE,closest_value(Epoch_06_28_14_WAVE,1340))]
NV_Spect_FX_3=[]
#------------------------------------------------------------------------------
#Normalization using Splines Method
...
plt.ylabel('Flux (ratio)')
plt.axhline(y=1,color='grey')
plt.plot(NV_Spect_WL_3,NV_Spect_FX_3,zorder=0,c='blue',linewidth=2)
...
"""
col1=fits.Column(name='wavelength',format='D',array=NV_Spect_WL_3)
col2=fits.Column(name='flux'      ,format='D',array=NV_Spect_FX_3)
col3=fits.Column(name='error'     ,format='D',array=NV_Spect_ER_3)
cols = fits.ColDefs([col1, col2, col3])
tbhdu = fits.BinTableHDU.from_columns(cols)
tbhdu.writeto('NV_Epoch_06_28_14.fits')
#"""